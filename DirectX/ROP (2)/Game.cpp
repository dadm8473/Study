...
void ChangeScene(string sceneName)
{
	...
	gAssetManager->GetSoundAsset("Main")->Stop();
	gAssetManager->GetSoundAsset("Stage1")->Stop();
	gAssetManager->GetSoundAsset("Stage2")->Stop();
	gAssetManager->GetSoundAsset("Win")->Stop();
	gAssetManager->GetSoundAsset("Lose")->Stop();

	gAssetManager->GetSoundAsset("Main")->Reset();
	gAssetManager->GetSoundAsset("Stage1")->Reset();
	gAssetManager->GetSoundAsset("Stage2")->Reset();
	gAssetManager->GetSoundAsset("Win")->Reset();
	gAssetManager->GetSoundAsset("Lose")->Reset();
