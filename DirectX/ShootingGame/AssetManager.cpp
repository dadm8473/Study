...
void AssetManager::LoadAssets()
{
	...
	LoadTexture("Player", L"image/GameObject/Player/Player00", L"png", 1);

	LoadTexture("Bullet", L"image/GameObject/Bullet/Bullet00", L"png", 1);

	LoadTexture("Map", L"image/Map/Map00", L"png", 1);
